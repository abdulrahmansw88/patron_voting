    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          MaterialButton(
            color: Colors.green,
              child:const Text("Vote character"),
              onPressed: (){
                voteCharacter("OMM8yBPqwwBvpNcdTlju");
              }
          ),
          ],
        ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          // registerUser(email: "abdul@rah.com", password: "112345");
          // _incrementCounter();

          // registerUser(email: "zeeshan@mail.com", password: "123421");
          signIn();
        },
        tooltip: 'Increment',
